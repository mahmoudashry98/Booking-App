      ...
      builder: (context, state) {
        ...
        return Container(
          ...
          child: ListView.separated(
                      ...
                      Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: CachedNetworkImage(
                            imageUrl:
                                'http://api.mahmoudtaha.com/images/${cubit.listCompletedBooking[index].hotelImages[0].image}',
                            height: context.height * 0.22,
                            fit: BoxFit.cover,
                        ...
                        child: Row(
                          children: [
                            Expanded(
                              child: CustomText(
                                text:
                                    cubit.listCompletedBooking[index].hotelName,
                            ...
                            CustomText(
                              text:
                                  cubit.listCompletedBooking[index].hotelPrice,
                              color: AppColors.black,
                              fontWeight: FontWeight.bold,
                              size: 20,
                            ),
            ...
            itemCount: cubit.listCompletedBooking.length,
          ),
        );
      },
    );
