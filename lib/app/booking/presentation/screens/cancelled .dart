      ...
      builder: (context, state) {
        ...
        return Container(
          ...
          child: ListView.separated(
                      ...
                      Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: CachedNetworkImage(
                            imageUrl:
                                'http://api.mahmoudtaha.com/images/${cubit.listCanceledBooking[index].hotelImages[0].image}',
                            height: context.height * 0.22,
                            fit: BoxFit.cover,
                        ...
                        child: Row(
                          children: [
                            Expanded(
                              child: CustomText(
                                text:
                                    cubit.listCanceledBooking[index].hotelName,
                            ...
                            const Spacer(),
                            CustomText(
                              text: cubit.listCanceledBooking[index].hotelPrice,
                              color: AppColors.black,
                              fontWeight: FontWeight.bold,
                              size: 20,
                            ),
            ...
            itemCount: cubit.listCanceledBooking.length,
          ),
        );
      },
    );
