    ...
    return Scaffold(
      ...
      body: BlocConsumer<SearchCubit, SearchState>(
        ...
        builder: (context, state) {
          print(searchCubit.listSearch.length);
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                CustomText(
                                  text:
                                      '${searchCubit.listSearch.length}   Hotel Found',
                                ...
                                onTap: () {
                                  Navigator.push(context,
                                    ...
                                    return HotelDetailsScreen(
                                      itemHotel: searchCubit.listSearch[index],
                                    );
                                  }));
                                },
                                child: Container(
                                      ...
                                      Container(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: CachedNetworkImage(
                                            imageUrl:
                                                '${ApiConstance.baseUrlImage}$image',
                                            height: context.height * 0.22,
                                            fit: BoxFit.cover,
